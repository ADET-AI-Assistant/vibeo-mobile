    ...
    >
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Text style={styles.subheading}>
          Sign in or create an account to sync your watchlist and history.
        </Text>
...
const styles = StyleSheet.create({
  root: { flex: 1, backgroundColor: "#10010b" },
  container: {
    flexGrow: 1,
  ...
  modeButtonActive: { backgroundColor: "#ff3f75" },
  modeText: { color: "#bba1b1", fontWeight: "700" },
  ...
  errorText: { color: "#ff9fba", marginBottom: 10, fontSize: 13 },
  primaryButton: {
    marginTop: 6,
    borderRadius: 12,
  ...
  primaryButtonText: { color: "#fff", fontWeight: "900", letterSpacing: 0.3 },
});
